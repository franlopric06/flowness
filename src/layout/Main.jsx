    ...
    <main className="pt-16">
      ...
      <section className="bg-[#F5F0EB] flex items-center justify-center px-6 py-16 text-center md:min-h-screen md:px-16">
        <div className="flex flex-col items-center max-w-2xl">
          ...
          <div className="flex flex-col gap-4 w-full md:flex-row md:w-auto">
            <Link to="/cursos" className="bg-[#7B9B77] text-white text-xs tracking-widest uppercase px-8 py-4 rounded-full text-center hover:bg-[#5a7a56] transition-colors">
              Explorar cursos
            </Link>
            <Link
              to="/clases"
      ...
      <section className="bg-[#E6D5B8]/30 border-t border-b border-[#D8A48F]/20">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <Link to="/cursos" className="py-8 text-center hover:bg-[#E6D5B8]/50 transition-colors cursor-pointer">
